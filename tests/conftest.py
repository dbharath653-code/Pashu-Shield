...
os.environ.update({
    ...
    # Telephony / IVR (Exotel webhook-secret validation against these test credentials)
    "TELEPHONY_PROVIDER": "exotel",
    "EXOTEL_ENABLED": "true",
    "EXOTEL_API_KEY": "test-exotel-api-key",
    "EXOTEL_API_TOKEN": "test-exotel-api-token",
    "EXOTEL_ACCOUNT_SID": "testaccountsid",
    "EXOTEL_SUBDOMAIN": "api.in.exotel.com",
    "EXOTEL_PHONE_NUMBER": "08047491899",
    "EXOTEL_APP_ID": "926",
    "EXOTEL_WEBHOOK_SECRET": "test-webhook-secret-0123456789abcdef0123456789",
    "EXOTEL_VALIDATE_WEBHOOK": "true",
    "EXOTEL_VERIFY_CALL_SID": "false",
